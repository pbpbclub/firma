...
export const financeApi = {
  ...
  createFixedObligation: (data: { name: string; amount: number; pay_day?: number; note?: string; master_id?: string | null }) =>
    api.post("/finance/fixed-obligations", data).then((r) => r.data),
  updateFixedObligation: (id: string, data: { name?: string; amount?: number; pay_day?: number; note?: string; active?: number; master_id?: string | null }) =>
