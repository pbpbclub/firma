...
export const CONTRACTOR_FIELDS: FieldDef[] = [
  ...
  { key: "role",           label: "Роль",
    // Роли (ТЗ 03.09.2026, п.5): партнёр — доля от прибыли, накладные — аренда/связь.
    // В «Мы должны» по умолчанию идут только мастера, подрядчики и поставщики.
    type: "select", options: [{ v: "Мастер", l: "Мастер" }, { v: "Подрядчик", l: "Подрядчик" },
                              { v: "Поставщик", l: "Поставщик" }, { v: "Партнёр", l: "Партнёр (доля от прибыли)" },
                              { v: "Накладные", l: "Накладные (аренда, связь, бухгалтерия)" }] },
