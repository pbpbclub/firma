  ...
  return (
    ...
    >
      ...
      <div style={{ display: "flex", alignItems: "baseline", gap: 8 }}>
        <span style={{ fontSize: 24, fontWeight: 700, letterSpacing: "-0.02em", color: TONES[tone], fontVariantNumeric: "tabular-nums" }}>{value}</span>
        {delta != null && <span style={{ fontSize: 12, fontWeight: 600, color: TONES[tone] }}>{delta}</span>}
      </div>
      {progress != null && (
