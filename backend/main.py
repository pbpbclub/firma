...
from db import ensure_zm_account_meta_schema, ensure_fx_rates_schema, ensure_abroad_categories_schema, ensure_abroad_infra_seed, ensure_zm_third_party_schema
...
app.include_router(third_party.router, prefix="/api/third-party", tags=["third-party"], **protected)
