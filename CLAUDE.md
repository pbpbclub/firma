...
- Фин-агент (handoff 11.09.2026): `design_costs.py` → только `POST …/import`, расходов
  не заводит; прислать точную разбивку ORD-054 от 08.09 (записана как cache-read
  приближённо). Mac — карта папок из API. YOS — `production.py` обёртки.
