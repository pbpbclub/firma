...
**Шапка главной** — `components/dashboard/HeroPanel.tsx`: свободные деньги полосой-водопадом
(`ui/SegBar`) + личные карты (`/zenmoney/accounts-summary`, RUB), ДДС по месяцам парными
